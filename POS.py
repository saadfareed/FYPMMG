...
#main work
urdu_text = remove_newline_tab_character(result)
urdu_text = removing_extra_character(urdu_text)
urdu_text = remove_newline_tab_character(urdu_text)
urdu_text = removing_diacritics(urdu_text)
urdu_text = removing_punctuations(urdu_text)
final=urdu_text.split()
#final.sort()
print(type(final))
print(final)
